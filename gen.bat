...
conan install .. -g cmake_multi -s build_type=Release -s compiler.runtime=MT
if NOT '%ERRORLEVEL%'=='0' goto fail 

conan install .. -g cmake_multi -s build_type=Debug -s compiler.runtime=MTd
if NOT '%ERRORLEVEL%'=='0' goto fail 


set generator=Visual Studio 15 2017 Win64

set error_message="cmake -G "%generator%" .. -DMULTI_CONFIG=ON"
cmake -G "%generator%" .. -DMULTI_CONFIG=ON
